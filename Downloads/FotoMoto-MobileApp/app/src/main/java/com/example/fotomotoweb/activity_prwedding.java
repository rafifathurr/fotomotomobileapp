...
public class activity_prwedding extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prwedding);
        ...
        cust_subject.setText("Pre-Wedding");
        ...
        slideModels.add(new SlideModel(R.drawable.prw1, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.prw2, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.prw3, ScaleTypes.FIT));
        ...
        date_book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker = new DatePickerDialog(activity_prwedding.this,
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity_prwedding.this, activity_service.class);
