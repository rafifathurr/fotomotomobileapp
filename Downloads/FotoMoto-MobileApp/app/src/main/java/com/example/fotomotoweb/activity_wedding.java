...
public class activity_wedding extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        slideModels.add(new SlideModel(R.drawable.wd1, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.wd2, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.wd3, ScaleTypes.FIT));
        ...
        date_book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker = new DatePickerDialog(activity_wedding.this,
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity_wedding.this, activity_service.class);
