...
public class activity_event extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cust_subject.setText("Event Photoshoot");
        form.setVisibility(View.INVISIBLE);

        List<SlideModel> slideModels = new ArrayList<>();
        slideModels.add(new SlideModel(R.drawable.ev1, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.ev2, ScaleTypes.FIT));
        slideModels.add(new SlideModel(R.drawable.ev3, ScaleTypes.FIT));
        ...
        date_book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker = new DatePickerDialog(activity_event.this,
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity_event.this, activity_service.class);
